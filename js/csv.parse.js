...
function bip() {
    ...
    if(counter == 0) finish++;
        ...
        document.getElementById("bip").innerHTML = "<div style='font-size:60px;font-weigth:bold;position:absolute;left:350px;width:100px;padding-left:30px;background-color:yellow;'>"+counter+"</div>";
    }	
}
function start(){
...
function setData(data) {
	...
	$( document ).ready(function() {
		document.getElementById("prenom").innerHTML = d1[6]["Votre prénom"]+"  ";
		document.getElementById("nom").innerHTML = d1[6]["Votre nom"];
		$("#photo").attr("src",getPhoto(6));

		$('#bensassi').delay(6000).fadeOut('slow')
